...
MySQL - 5.5.53 : Database - jiehuocmf
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`jiehuocmf` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `cmf_category` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `category` varchar(100) DEFAULT NULL COMMENT '分类名',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='网站内容分类';

/*Data for the table `cmf_category` */
...
insert  into `cmf_option`(`id`,`autoload`,`option_name`,`option_value`) values (7,1,'site_info','{\"site_name\":\"\\u89e3\\u60d1\\u6587\\u5316\",\"site_seo_title\":\"\\u89e3\\u60d1\\u6587\\u5316\",\"site_seo_keywords\":\"\\u89e3\\u60d1\\u6587\\u5316\",\"site_seo_description\":\"\\u89e3\\u60d1\\u6587\\u5316\"}');
...
/*Table structure for table `cmf_post` */

DROP TABLE IF EXISTS `cmf_post`;
...
CREATE TABLE `cmf_post` (
  ...
  `user_id` int(11) DEFAULT '0' COMMENT '发布者id',
  `hits` int(11) NOT NULL DEFAULT '0' COMMENT '访问查看数',
  `create_time` int(11) DEFAULT NULL,
  `update_time` int(11) DEFAULT NULL,
  `delete_time` int(11) DEFAULT NULL,
  `title` varchar(100) DEFAULT NULL COMMENT '标题',
  `category_id` int(11) DEFAULT '0' COMMENT '分类id',
  `category` varchar(200) DEFAULT NULL COMMENT '分类名',
  `thumb` varchar(255) DEFAULT NULL COMMENT '缩略图',
  `videourl` varchar(255) DEFAULT NULL COMMENT '视频地址',
  `content` text COMMENT '文章内容',
  `sort` int(11) DEFAULT '0' COMMENT '排序,数字越大列表越前',
  `status` int(11) DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='网站所有栏目内容数据表';

/*Data for the table `cmf_post` */
...
insert  into `cmf_slide`(`id`,`status`,`delete_time`,`name`,`remark`) values (1,1,0,'ffff','ffff');

/*Table structure for table `cmf_slide_banner` */

DROP TABLE IF EXISTS `cmf_slide_banner`;

CREATE TABLE `cmf_slide_banner` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `status` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '状态,1:显示;0:隐藏',
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
...
/*Data for the table `cmf_slide_banner` */
...
insert  into `cmf_theme`(`id`,`create_time`,`update_time`,`status`,`is_compiled`,`theme`,`name`,`version`,`demo_url`,`thumbnail`,`author`,`author_url`,`lang`,`keywords`,`description`) values (19,0,0,0,0,'simpleboot3','simpleboot3','1.0.2','http://demo.thinkcmf.com','','ThinkCMF','http://www.thinkcmf.com','zh-cn','ThinkCMF模板','ThinkCMF默认模板'),(20,0,0,0,0,'jiehuo','jiehuo','1.0','http://www.jiehuocm.com','','wl','','zh-cn','解惑文化企业官网','解惑文化企业官网');
...
insert  into `cmf_user`(`id`,`user_type`,`sex`,`birthday`,`last_login_time`,`score`,`coin`,`create_time`,`user_status`,`user_login`,`user_pass`,`user_nickname`,`user_email`,`user_url`,`avatar`,`signature`,`last_login_ip`,`user_activation_key`,`mobile`,`more`) values (1,1,0,0,1508135182,0,0,1507291431,1,'admin','###c28e67dc620d013564976b7382aa718e','admin','132@qq.com','','','','127.0.0.1','','',NULL);
...
insert  into `cmf_user_action`(`id`,`score`,`coin`,`reward_number`,`cycle_type`,`cycle_time`,`name`,`action`,`app`,`url`) values (1,1,0,1,1,1,'用户登录','login','user','');
...
insert  into `cmf_user_token`(`id`,`user_id`,`expire_time`,`create_time`,`token`,`device_type`) values (3,1,1523687182,1508135182,'6046b31e4ee1f69e086d4955a1f88c426046b31e4ee1f69e086d4955a1f88c42','web');
